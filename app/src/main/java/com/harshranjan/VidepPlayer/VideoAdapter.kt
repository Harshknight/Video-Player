...
import com.harshranjan.VidepPlayer.databinding.DetailsViewBinding
import com.harshranjan.VidepPlayer.databinding.RenameFieldBinding
import com.harshranjan.VidepPlayer.databinding.VideoMoreFeaturesBinding
import com.harshranjan.VidepPlayer.databinding.VideoViewBinding
import java.io.File
...
class VideoAdapter(private val context: Context, private var videoList: ArrayList<Video>, private var isFolder: Boolean = false)
    ...
    override fun onBindViewHolder(holder: MyHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        Glide.with(context)
            ...
            .apply(RequestOptions().placeholder(R.drawable.about_icon).centerCrop())
            .into(holder.image)
